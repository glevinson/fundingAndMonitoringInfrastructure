...
const signingAddress = "0x1497914eC6B09E7749cFCc09b31623867F438848"

const rftAddress = "0x062E6Bb1fEd9b3571CF89d76639424Ec82fAefBE"

const foo = async function() {
    const nft = (new ethers.Contract(projectMarketplaceAddress, abiNFT, provider ))
   
    const rft = (new ethers.Contract("0x062E6Bb1fEd9b3571CF89d76639424Ec82fAefBE", abiRFT, provider))

    // console.log(typeof(nft))
    // console.log(typeof(rft))

    console.log((await rft.totalSupply()).toNumber())
    console.log((await rft.balanceOf(signingAddress)).toNumber())
  }
